...
fn style(status: Status, hier: Option<&ButtonHierarchy>) -> widget::button::Style {
    ...
    if hier == &ButtonHierarchy::Primary {
        style.shadow = Shadow {
    ...
    pub fn button(&self, params: UiButton<Message>) -> Element<'static, Message> {
        ...
        button(
            text(label)
                ...
                .width(Fill)
                .size(14)
                .style(move |_| match props.get_hier() {
                    ButtonHierarchy::Primary => text::Style {
                        color: Some(Color::from_rgb8(255, 255, 255)),
                    },
                    ButtonHierarchy::Secondary => text::Style {
                        color: Some(Color::from_rgb8(25, 31, 38)),
                    },
                }),
        )
